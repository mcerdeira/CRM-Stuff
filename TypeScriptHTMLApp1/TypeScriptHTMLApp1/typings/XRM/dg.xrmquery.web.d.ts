...
declare namespace XQW {
    ...
    class CreateRecord<ICreate> extends Query<string> {
        private record;
        constructor(entityPicker: (x: WebEntities) => WebMappingCUD<ICreate, any>, record?: ICreate | undefined);
    ...
    class DeleteRecord extends Query<undefined> {
        private id;
        constructor(entityPicker: (x: WebEntities) => WebMappingCUD<any, any>, id?: string | undefined);
    ...
    class UpdateRecord<IUpdate> extends Query<undefined> {
        private id;
        private record;
        constructor(entityPicker: (x: WebEntities) => WebMappingCUD<any, IUpdate>, id?: string | undefined, record?: IUpdate | undefined);
        protected handleResponse(req: XMLHttpRequest, successCallback: (x?: undefined) => any): void;
