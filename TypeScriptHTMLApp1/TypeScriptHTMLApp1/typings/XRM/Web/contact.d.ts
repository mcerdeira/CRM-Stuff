interface Contact_Base extends WebEntity {
  ...
  int_facebook?: string | null;
  int_facebookservice?: string | null;
  int_kloutscore?: number | null;
  int_kloutscoreservice?: number | null;
  int_twitter?: string | null;
  int_twitterservice?: string | null;
...
interface Contact_Select {
  ...
  int_facebook: WebAttribute<Contact_Select, { int_facebook: string | null }, {  }>;
  int_facebookservice: WebAttribute<Contact_Select, { int_facebookservice: string | null }, {  }>;
  int_kloutscore: WebAttribute<Contact_Select, { int_kloutscore: number | null }, {  }>;
  int_kloutscoreservice: WebAttribute<Contact_Select, { int_kloutscoreservice: number | null }, {  }>;
  int_twitter: WebAttribute<Contact_Select, { int_twitter: string | null }, {  }>;
  int_twitterservice: WebAttribute<Contact_Select, { int_twitterservice: string | null }, {  }>;
...
interface WebEntities {
  contacts: WebMappingRetrieve<Contact_Select,Contact_Expand,Contact_Filter,Contact_Fixed,Contact_Result,Contact_FormattedResult> & WebMappingCUD<Contact_Create,Contact_Update> & WebMappingRelated<Contact_RelatedOne,Contact_RelatedMany>;
}
